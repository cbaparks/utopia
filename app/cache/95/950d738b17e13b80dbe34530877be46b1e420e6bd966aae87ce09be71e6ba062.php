...
class __TwigTemplate_e104dcfe19d47431c0699f6e03f4d7d478b9c630edbc2d00ad02e84af4697149 extends Twig_Template
{
...
";
    ...
    ";
        ...
        // line 24
        echo "    ";
        $context["__internal_c18da361d309527386aa709fcf97062d4c8fde7b6d95dc3fab9330105262ab68"] = $this->loadTemplate("changelog/_macros.twig", "components/panel-lastmodified.twig", 24);
        // line 25
        echo "
    <ul>
        ";
        ...
        if ($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "changelog", array(), "any", true, true)) {
            ...
            foreach ($context['_seq'] as $context["index"] => $context["entry"]) {
                ...
                echo "
                    ";
                // line 41
                echo $context["__internal_c18da361d309527386aa709fcf97062d4c8fde7b6d95dc3fab9330105262ab68"]->getchangelog_mutation($this->getAttribute($context["entry"], "mutation_type", array()));
                echo "
                    ";
                // line 42
